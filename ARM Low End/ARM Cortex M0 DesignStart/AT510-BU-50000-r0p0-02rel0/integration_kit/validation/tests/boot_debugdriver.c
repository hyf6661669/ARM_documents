...
//
// Boot (vectors) file for Cortex-M0 Integration Kit Debug Driver
//
...
__attribute__ ((section("vectors"))) = {
  (vect_t)(0x20100000),     // Top of Stack
...
//
// Debug Driver cannot end the simulation
//
