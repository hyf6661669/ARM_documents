...
if($model_type == "DSM" ) then 
   ...
   echo "          |--> DSM/"
   echo "          |     |"
   echo "          |     |--> synopsys_vcs_verilog_Linux/"
   echo "          |             |"
...
if ($model_type == "DSM" ) then
   ...
   if ($model_base != "SWIFT" &&  $model_base != "OMI" ) then
       ...
       echo "   $unpack_dir/simulation_models/DSM/synopsys_vcs_verilog_Linux/CORTEXM0_unlicensed_r0p0-00rel0"
   ...
   setenv CORTEXM0_HOME $unpack_dir/simulation_models/DSM/synopsys_vcs_verilog_Linux/CORTEXM0_unlicensed_r0p0-00rel0
   $CORTEXM0_HOME/CORTEXM0.Linux/install_swift.csh $install_dir
   ...
   if ( $install_dir != $unpack_dir/simulation_models/LMC_HOME ) then
       ...
       echo "modify the "
       echo "   $unpack_dir/simulation_models/DSM/synopsys_vcs_verilog_Linux/CORTEXM0_unlicensed_r0p0-00rel0/setup.(c)sh "
