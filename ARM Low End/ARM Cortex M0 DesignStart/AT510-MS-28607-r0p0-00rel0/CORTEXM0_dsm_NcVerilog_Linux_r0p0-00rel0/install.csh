...
if ($model_type == "DSM" ) then
   ...
   if ($model_base != "SWIFT" &&  $model_base != "OMI" ) then
       ...
       echo "   $unpack_dir/simulation_models/DSM/cadence_nc_verilog_Linux/CORTEXM0_unlicensed_r0p0-00rel0"
   ...
   setenv CORTEXM0_HOME $unpack_dir/simulation_models/DSM/cadence_nc_verilog_Linux/CORTEXM0_unlicensed_r0p0-00rel0
   ...
   if ( $install_dir != $unpack_dir/simulation_models/LMC_HOME ) then
       ...
       echo "modify the "
       echo "   $unpack_dir/simulation_models/DSM/cadence_nc_verilog_Linux/CORTEXM0_unlicensed_r0p0-00rel0/setup.(c)sh "
